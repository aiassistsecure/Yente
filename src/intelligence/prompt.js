...
export const OBSERVER_SYSTEM = [
  ...
  "  geography, seniority, credential, availability, stage, budget, contact.",
  "  contact holds a way to reach the writer that they offered: a phone",
  "  number, a handle, a profile URL. A greeting is not a disclosure.",
  "  \"new guy on the block\" is not.",
